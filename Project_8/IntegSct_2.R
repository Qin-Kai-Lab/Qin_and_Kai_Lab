...
ggsave("Sct_2_Elbow.png", plot = elbPlot, height = 10, width = 10, dpi = 300, units = "in")
# 
# 
dir.create("Integrated_Clustering/PCA/", recursive = T)
dir.create("Integrated_Clustering/Resols/", recursive = T)
# 
# saveRDS(combObj, "SctInteg_selFov.rds")
...
for (curPc in pcs ) {
  ...
  p <- clustree(clustree)
  ggsave(paste0("Integrated_Clustering/PCA/ClustTree_PCs_",curPc, ".png"), plot = p, height = 12, width = 14, units = 'in', dpi = 300)
