...
for (curPc in pcs ) {
  ...
  dir.create(paste0("Integrated_RegNorm_Clustering/Images/", curPc), recursive = T, showWarnings = F)
  for (curResol in resols) {
    ...
    ggsave(paste0("Integrated_RegNorm_Clustering/Images/", curPc, "/Resol_", curResol, ".png"), plot=p3, height = 14, width = 20, units = 'in', dpi = 300)
