...
#saveRDS(projFilt, 'atacArchRnaFiltMacs2PerClust')

rm(projMacs2)

# differential expression
targDir <- './archContrStress/atacRna/StressVsControl/Macs2_0.001_PerCluster/'
dir.create(targDir)
...
write.csv(allClustMark, paste0(targDir, 'StressVsControl_Macs2PerClust_allClusters', curDate, '.csv'), row.names = F)

#allClustMark = read.csv(paste0(targDir, 'StressVsControl_Macs2_allClusters', curDate, '.csv'))

# get annotations
targDir <- './archContrStress/atacRna/StressVsControl/Macs2_0.001_PerCluster/Annotations/'
...
targDir <- './archContrStress/atacRna/StressVsControl/Macs2_0.001_PerCluster/Annotated/'
dir.create(targDir)
