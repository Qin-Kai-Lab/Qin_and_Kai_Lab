...
#df201 = read.csv("Paper_figs/TasksList/P26/PredictGene_20KB_RNA_spearman_AllClusters_SepGroups_2024-01-03.csv")

# dfDef = read.csv("Paper_figs/TasksList/P26/PredictGene_RNA_spearman_AllClusters_SepGroups_SubSamp_2024-01-12.csv")
# df20 = read.csv("Paper_figs/TasksList/P26/PredictGene_20KB_RNA_spearman_AllClusters_SepGroups_SubSamp_2024-01-12.csv")

dfDef = read.csv("Paper_figs/TasksList/P26/PredictGene_RNA_spearman_AllClusters_SepGroups_SubSamp_2024-01-16.csv")
df20 = read.csv("Paper_figs/TasksList/P26/PredictGene_20KB_RNA_spearman_AllClusters_SepGroups_SubSamp_2024-01-16.csv")
...
p = p + facet_grid(cols = vars(Group))  + theme(axis.text.y = element_text(size = 12))
ggsave(file = "Paper_figs/TasksList/P26/Boxp_RNA_ATAC_Cor_Pval_SepGroup_SubSamp_2024-01-16_Log.png", plot = p, height = 10, width = 12, units = "in", dpi = 300)
...
p = p + facet_grid(cols = vars(Group))  + theme(axis.text.y = element_text(size = 12))
ggsave(file = "Paper_figs/TasksList/P26/Violin_RNA_ATAC_Cor_Pval_SepGroup_SubSamp_2024-01-16_Log.png", plot = p, height = 10, width = 12, units = "in", dpi = 300)