...
cell.use = rownames(meta)[meta$group == "Control" & meta$Annotations != "C-R"] # extract the cell names from disease data
...
#saveRDS(cellchat,  "CellChat_RNA_Control")

cellchat = readRDS("CellChat_RNA_Control")
...
targDir = "Paper_figs/TasksList/P28/Control/"
