...
stressPeak <- readRDS('../data/atacAllFiltMacs2_control_1.87gensize_broad')
...
targetDir<-'Atac_Rna_coverPlots/Control_only/macs2/gensize1.87_broad/ext50kb/'
...
for ( i in presentGenes){
  ...
  outFile<-paste0(targetDir, 'CovPlot_AtacRna_macs2_contrOnly_gensize1.87_broad_ext50k_', i, '_', curDate, '.jpeg')
