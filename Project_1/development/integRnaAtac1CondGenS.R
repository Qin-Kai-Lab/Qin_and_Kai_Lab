...
targetDir<-'Atac_Rna_coverPlots/Control_only/macs2/gensize1.87/ext50kb/'
...
for ( i in presentGenes){
  ...
  outFile<-paste0(targetDir, 'CovPlot_AtacRna_macs2_contrOnly_gensize1.87_ext50k_', i, '_', curDate, '.jpeg')
