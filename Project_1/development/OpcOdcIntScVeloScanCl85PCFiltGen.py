...
sc.tl.pca(adata, svd_solver='arpack', n_comps = 85)
sc.pl.pca_variance_ratio(adata, log=True, n_pcs = 85)
sc.pp.neighbors(adata,  n_pcs = 85)
...
scv.pp.moments(adata, n_pcs=85, n_neighbors=30)
...
outStream="OpcOdcInt_scvelo_scanClust_85PC_%s.png" % curDate

outGr="OpcOdcInt_scvelo_scanClust_85PC_StrvsContr_%s.png" % curDate
