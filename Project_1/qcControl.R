...
table(rnaContrFiltr@meta.data$DF.classifications_0.25_0.22_749)

rnaContrFiltr@meta.data$CellID<-rownames(rnaContrFiltr@meta.data)

doubletFiltr<-subset(x = rnaContrFiltr, subset = DF.classifications_0.25_0.22_749 == "Singlet")
