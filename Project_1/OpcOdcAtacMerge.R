...
stress <- readRDS('OpcOdc_stress_macs2')
control <- readRDS('OpcOdc_control_macs2')
...
##  looks like dataset it too small for integration

setwd('../output')


#saveRDS(integrated, file = 'atacIntegrated_macs2')
saveRDS(pbmc.combined, file = 'OpcOdc_atacMerged_macs2')
